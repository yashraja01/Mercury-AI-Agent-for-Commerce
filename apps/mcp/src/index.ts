 ...
 * `total_paise` from its caller would put an LLM in the money path, which is
...
server.registerTool(
  "search_catalog",
  {
    ...
    description:
      "The merchant's machine-readable feed: stable SKUs, list price in paise, live stock and " +
  ...
  "request_quote",
  {
    ...
    inputSchema: {
      ...
      message: z
        .string()
        .min(1)
        .describe("What you want, in a sentence. e.g. 'two bags of rice and a pack of tea'."),
    },
  },
