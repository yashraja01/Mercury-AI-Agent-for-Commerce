...
/**
 * Dwaar, read as a sentence before it is read as an instrument.
 *
    ...
    <section className="panel flex min-h-0 flex-col">
      <div className="panel-head flex items-baseline justify-between gap-4 px-4 py-3">
        <h2 className="display text-[15px] text-paper">
          The gate
          <span className="deva ml-2.5 text-[14px] font-normal text-paper-dim">द्वार</span>
        </h2>
        <button
          type="button"
      ...
      <div className="border-b border-rule px-4 py-4">
        ...
        {verdict === null ? (
          ...
          <p className="mt-3 border border-vermilion-dim bg-vermilion/10 px-3 py-2 text-[12.5px] leading-relaxed text-vermilion">
            The agent&apos;s arithmetic was out by {paiseExact(Math.abs((quoted ?? 0) - (computed ?? 0)))}.
