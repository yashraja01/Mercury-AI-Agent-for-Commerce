 ...
 * reading its label.
 *
 * Nothing here is advisory. Each control is a Dwaar rule, and the gate refuses
...
function NumberControl(props: {
  ...
  const shown =
    props.value === 0
      ? "no limit"
      : `${props.prefix ?? ""}${props.value.toLocaleString("en-IN")}${props.unit === undefined ? "" : ` ${props.unit}`}`;
