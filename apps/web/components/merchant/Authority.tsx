  ...
  return (
    <section className="flex min-h-0 flex-col">
        ...
        {envelopes.length === 0 ? (
          ...
          envelopes.map((e) => {
            const used =
              e.reserved_paise === 0
                ? 0
                : Math.min(100, (e.consumed_paise / e.reserved_paise) * 100);
            ...
            return (
              <div key={e.mandate_id} className="min-w-0">
                ...
                <p className="mt-2.5 text-[13.5px] leading-relaxed text-paper-dim">
                  ...
                  <span className="figures text-paper">{rupees(e.remaining_paise)}</span> more
                  here, across{" "}
      ...
      <p className="mt-4 text-[12px] leading-relaxed text-paper-faint">
        Either can run out first. A budget with rupees left but no orders left is
