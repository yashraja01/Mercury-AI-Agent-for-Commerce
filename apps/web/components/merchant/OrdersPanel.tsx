 ...
 * status is Razorpay's, and they advance independently on webhooks that arrive
    ...
    <section className="flex min-h-0 flex-col">
            ...
            {orders.map((o) => (
              ...
              >
                ...
                <Pill
                  ...
                  title={split ? "Razorpay payment state" : undefined}
                >
      ...
      {split ? (
        <p className="mt-3 text-[12px] leading-relaxed text-paper-faint">
          ...
          when we act; Razorpay&apos;s advances on a webhook that may arrive late,
